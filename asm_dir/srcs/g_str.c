...
/*   Updated: 2019/06/12 12:24:00 by rcepre      ###    #+. /#+    ###.fr     */
/*                                                         /                  */
/*                                                        /                   */
/* ************************************************************************** */
...
const char *g_str[STR_NB] =
	{
		...
		"bad file extension ",
		B_BLACK "(the output file should have an " B_WHITE ".cor" B_BLACK " extension)\n",
		"this champion sucks ...",
		"label already set",
		"corrupted file",
		"missing terminating '\"' character " B_BLACK " (do not support multi-lines names)",
		"missing terminating '\"' character " B_BLACK " (do not support multi-lines comments)",
		"comment already set",
		"name already set",
		"missing comment",
		"missing name",
		"missing file extension " B_BLACK " (should be " B_WHITE ".s" B_BLACK ")" RESET,
		"invalid option: ",
		...
		"--output  (-o) :  Define the outpute name.\n"
